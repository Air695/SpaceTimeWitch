...
public class STWIronChestplate : SpaceTimeWitchCards
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        await PowerCmd.Apply<STWChestplate1>(choiceContext, Owner.Creature,1, Owner.Creature, this);
    }
