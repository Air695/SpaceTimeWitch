...
public class STWNetheriteChestplate : SpaceTimeWitchCards
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        await PowerCmd.Apply<STWChestplate3>(choiceContext, Owner.Creature,1, Owner.Creature, this);
    }
