...
public class STWNetheriteBoots : SpaceTimeWitchCards
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        await PowerCmd.Apply<STWBoots4>(choiceContext, Owner.Creature,1, Owner.Creature, this);
    }
