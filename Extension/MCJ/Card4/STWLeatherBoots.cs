...
public class STWLeatherBoots : SpaceTimeWitchCards
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        await PowerCmd.Apply<STWBoots1>(choiceContext, Owner.Creature,1, Owner.Creature, this);
    }
