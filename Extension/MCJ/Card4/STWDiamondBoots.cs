...
public class STWDiamondBoots : SpaceTimeWitchCards
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        ...
        await PowerCmd.Apply<STWBoots3>(choiceContext, Owner.Creature,1, Owner.Creature, this);
    }
