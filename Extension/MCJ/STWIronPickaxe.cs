...
public class STWIronPickaxe : TagRelic, IPickaxeRelic
{
    public static readonly SavedAttachedState<STWIronPickaxe, int> Materials =
        new("Iron_Materials", _ => 0);

    public static readonly SavedAttachedState<STWIronPickaxe, int> UpgradeProgress =
        new("Iron_UpgradeProgress", _ => 9);

    public static readonly SavedAttachedState<STWIronPickaxe, string> CardBindings =
        new("Iron_CardBindings", _ => PickaxeCardBindings.DefaultsSerialized);

    public static readonly SavedAttachedState<STWIronPickaxe, string> DoorData = new("Iron_DoorData", _ => "");
    public static readonly SavedAttachedState<STWIronPickaxe, string> SpearData = new("Iron_SpearData", _ => "");
    public static readonly SavedAttachedState<STWIronPickaxe, string> ShieldData = new("Iron_ShieldData", _ => "");
    ...
    {
        var nextId = ModelDb.GetId(typeof(STWDiamondPickaxe));
        ...
        if (next is STWDiamondPickaxe d)
        {
            STWDiamondPickaxe.DoorData[d] = DoorData[this];
            STWDiamondPickaxe.SpearData[d] = SpearData[this];
            STWDiamondPickaxe.ShieldData[d] = ShieldData[this];
        }
